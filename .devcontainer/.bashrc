...
# Note in order to use tasks in vscode this is commented out
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]($CONTAINER_NAME) \u\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}($CONTAINER_NAME) \u:\w\$ '
fi
...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\e]0;${debian_chroot:+($debian_chroot)}($CONTAINER_NAME) \u: \w\a\]$PS1"
    ;;
*)
    ;;
esac
