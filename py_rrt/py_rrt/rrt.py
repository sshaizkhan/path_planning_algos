...
Original Author: AtsushiSakai(@Atsushi_twi) (https://github.com/AtsushiSakai/PythonRobotics/blob/master/PathPlanning/RRT/rrt.py)
...
class RRT:
    ...
    def __init__(
        ...
        playArea: stay inside this area [xmin, xmax, ymin, ymax]
        robotRadius: robot body modeled as circle with given radius
        """
    ...
    def planning(self, animation: bool = True):
        """
        rrt path planning
        animation flag: flag for animation
        """
